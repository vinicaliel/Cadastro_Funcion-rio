...
@PutMapping("/{id}")
public Departamento Update(@PathVariable long id, @Valid @RequestBody Departamento departamentToUpdate) {
    return departamentService.Update(id, departamentToUpdate);
}
}
